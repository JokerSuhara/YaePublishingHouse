...
image: "https://free.picui.cn/free/2026/02/24/699d84c99cfd5.png"
tags: [CTF, Pwn]
category: CTF
draft: false
slug: sparkctf-2026-pwn-wp
...
>
> 在 glibc x86_64 的 `setcontext.S` 里，可以看到它会从你提供的上下文里至少恢复这些关键值：
>
> * `rsp`
...
> [!NOTE]
> 这来自*2025年浙江省大学生网络与信息安全竞赛决赛*，qemu等环境配置可参考下面这位师傅的文章➡️[异架构pwn学习入门](https://sysnow.xyz/blog/cross_architecture_introduction/)
...
> [!WARNING]
> kali的镜像源里面没有这个东西，不安装不影响做题，Ubuntu可以正常安装
...
![请输入图片描述](https://free.picui.cn/free/2026/02/24/699d99f049413.png)
