...
![image.png](http://joker233.top/usr/uploads/2025/11/2550076678.png)

再看看IDA

![image.png](http://joker233.top/usr/uploads/2025/11/2136739723.png)
...
![image.png](http://joker233.top/usr/uploads/2025/11/2643778782.png)

发现Canary在[font color="0000FF"]**0x7fffffffdc80 + 0x8**[/font]的位置

用 `fmtarg`（需先安装pwngdb，并设置与pwndbg联动使用）计算出Canary的偏移是[font color="#FF1493"]**19**[/font]

![image.png](http://joker233.top/usr/uploads/2025/11/2407971303.png)

测试一下，没问题

![image.png](http://joker233.top/usr/uploads/2025/11/2714028680.png)

这里要注意，[font color="#FF1493"]**%19$p**[/font]已经有五个字节了，如果使用 `sendline`来发送payload，多出来的换行符会直接用于下一个 `read`，导致程序提前结束
